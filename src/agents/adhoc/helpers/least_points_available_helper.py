...
#         return self.get_least_points_available(game_board, hand_chips, ignore_blue)
#
#     def get_least_points_available(self, game_board, hand_chips, ignore_blue):
#         zero_point_place_action = self.process_zero_point_placements(game_board, hand_chips)
#         if zero_point_place_action is not None:
#             return 0
...
#         return None
#
#     def process_zero_point_placements(self, game_board, hand_chips):

...
class TakeLeastPointsStrategy(AdhocStrategy):
    ...
    def give_strategy_result(self, game_board, combinations, last_placed_chip):
        ...
        minimum_points = min(total_points_per_combination)
        return combinations[total_points_per_combination.index(minimum_points)]

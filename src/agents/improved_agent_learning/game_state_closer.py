...
#         final_state = self.game_path.state_data_list[0]
#         pre_final_state = self.game_path.state_data_list[1]
#         final_relation = self.game_path.relation_data_list[0]
#
...
#                 pre_pre_final_state = self.game_path.state_data_list[2]

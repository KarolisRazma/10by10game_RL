...
SIMPLE_1 = "SimpleAgent1"
SIMPLE_2 = "SimpleAgent2"
IMPROVED_1 = "ImprovedAgent1"
IMPROVED_2 = "ImprovedAgent2"

# Agent vs Agent:
BRUTE_VS_BRUTE = f'{BRUTE_1} VS {BRUTE_2}'
SIMPLE_AGENT_1_VS_BRUTE = f'{SIMPLE_1} VS {BRUTE_1}'
SIMPLE_AGENT_2_VS_BRUTE = f'{SIMPLE_2} VS {BRUTE_1}'
IMPROVED_AGENT_1_VS_BRUTE = f'{IMPROVED_1} VS {BRUTE_1}'
IMPROVED_AGENT_2_VS_BRUTE = f'{IMPROVED_2} VS {BRUTE_1}'
SIMPLE_AGENT_1_VS_SIMPLE_AGENT_2 = f'{SIMPLE_1} VS {SIMPLE_2}'
IMPROVED_AGENT_1_VS_SIMPLE_AGENT_1 = f'{IMPROVED_1} VS {SIMPLE_1}'
IMPROVED_AGENT_1_VS_SIMPLE_AGENT_2 = f'{IMPROVED_1} VS {SIMPLE_2}'
IMPROVED_AGENT_2_VS_SIMPLE_AGENT_1 = f'{IMPROVED_2} VS {SIMPLE_1}'
IMPROVED_AGENT_2_VS_SIMPLE_AGENT_2 = f'{IMPROVED_2} VS {SIMPLE_2}'
...
# Delete graphs:
DELETE_SIMPLE_AGENT_1_GRAPH = f'Delete {SIMPLE_1} graph'
DELETE_SIMPLE_AGENT_2_GRAPH = f'Delete {SIMPLE_2} graph'
DELETE_SIMPLE_AGENT_GRAPHS = "Delete both SimpleAgent graphs"

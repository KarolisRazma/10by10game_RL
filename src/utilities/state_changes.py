...
class StateChangeData:
    def __init__(self, is_my_turn, game_board, enemy_score, container_chips_count, container, placing_action=None,
...
class InitialStateData:
    def __init__(self, game_board, container_chips_count, is_starting, last_placed_chip):
        self.game_board = game_board
        self.container_chips_count = container_chips_count

...
# Agents ids
RANDOM_WALKER_1 = "RandomWalkerAgent1"
RANDOM_WALKER_2 = "RandomWalkerAgent2"
IMPROVED_1 = "ImprovedAgent1"
IMPROVED_2 = "ImprovedAgent2"

# Agent vs Agent:
RANDOM_WALKER_VS_RANDOM_WALKER = f'{RANDOM_WALKER_1} VS {RANDOM_WALKER_2}'
IMPROVED_AGENT_1_VS_RANDOM_WALKER = f'{IMPROVED_1} VS {RANDOM_WALKER_1}'
IMPROVED_AGENT_2_VS_RANDOM_WALKER = f'{IMPROVED_2} VS {RANDOM_WALKER_1}'

...
session_improved_agent_1 = driver.session(database="agent1-20231105-localreward")
graph_improved_agent_1 = Graph(driver, session_improved_agent_1)

session_improved_agent_2 = driver.session(database="agent2-20231105-localreward")
...
class GameInterface:
    ...
    def do_benchmarking(self, benchmarks_playing, benchmarks_evaluation, benchmarking_counter):
        ...
        path = f'/home/karolisr/Studijos/2023-2024_RUDUO/kursinio_projektas/NAUJI_MATAVIMAI/20231105/benchmarks/'
